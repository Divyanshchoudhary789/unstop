            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="flex flex-col md:items-start  mb-2">
                    ...
                    <h2 className="text-[15px] text-gray-800 mt-2 md:mt-0">
                        Experience India’s biggest cultural, technical, and sports college fests in one place.
                    </h2>
                </div>
                    ...
                    <div className="flex gap-8">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex flex-col gap-6">
                                <CommanCard
                                    title="Vaayu"
                                    company="Anil Surendra Modi School of Commerce (ASMSOC), NMIMS, Mumbai"
                                    type="College Fest"
                                    totalCompetitions={7}
                                    impressions={4282}
                                    postedDate="Feb 13, 2026"
                                    logo="https://d8it4huxumps7.cloudfront.net/images/icons/Competition128.png?d=146x146"
                                />
                                <CommanCard />
                            </div>
