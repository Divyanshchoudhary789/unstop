            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="flex flex-col md:items-start  mb-2">
                    <h1 className="text-[40px] font-bold text-gray-950">
                        1712+ Scholarships in India
                    </h1>

                    <h2 className="text-[15px] text-gray-800 mt-2 md:mt-0">
                        Get financial support to fund your education and college journey.
                    </h2>
                </div>
                    ...
                    <div className="flex gap-8">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex flex-col gap-6">
                                <CommanCard
                                    title="Tally Prime"
                                    company="Quality Thought Info Systems"
                                    ...
                                    daysLeft={23}
                                    logo="https://d8it4huxumps7.cloudfront.net/uploads/images/150x150/uploadedManual-699c480eebc16_quality-thought-logo-software-training-institute-india.jpg.jpeg"
                                />
                                <CommanCard />
                            </div>
