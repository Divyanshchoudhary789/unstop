            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="flex flex-col md:items-start  mb-2">
                    ...
                    <h2 className="text-[15px] text-gray-800 mt-2 md:mt-0">
                        Paid, remote & summer internships for students and freshers
                    </h2>
                </div>
                    ...
                    <div className="flex gap-8">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex flex-col gap-6">
                                <InternshipCard
                                    title="Open AI/ GenAI Internship"
                                    company="Intelligenxe Inc."
                                    ...
                                    daysLeft={14}
                                    logo="https://d8it4huxumps7.cloudfront.net/uploads/images/150x150/uploadedManual-696288ff3dc4c_intelligenxe_l_w_lighter.png"
                                />
                                <InternshipCard />
                                <InternshipCard />
                                <InternshipCard />
